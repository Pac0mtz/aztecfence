          ...
          <div className="space-y-10">
            {[
              ...
              },
              {
                ...
                text: "When you use our contact form we collect your name, email address, phone number, the fencing service you selected, and any message you send. We also receive the phone number when you tap Call. Our servers may log technical data such as IP address, browser type, and the page you visited. If you click a Google Ad, Google may pass click identifiers (such as gclid) so we can measure which ads led to a quote request or call.",
              },
              {
